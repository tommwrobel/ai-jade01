...
public class NewServiceAgent extends Agent {
    protected void setup () {
        ...
        addBehaviour(new PolishCyclicBehaviour(this));
        //doDelete();
    }
...
class PolishCyclicBehaviour extends CyclicBehaviour
{
    NewServiceAgent agent;
    public PolishCyclicBehaviour(NewServiceAgent agent) {
        this.agent = agent;
    }
    public void action()
    {
        MessageTemplate template = MessageTemplate.MatchOntology("polish");
